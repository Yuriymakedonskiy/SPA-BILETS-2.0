...
;( function( $, window, document, undefined ) {
    ...
    $.extend( Plugin.prototype, {
        init: function() {
           ...
           if(_this.settings.lock_destination == false){
            ...
            butTwidget.addEventListener('click', () => {
                ...
                var abc = a.prevObject.context.innerText
        ...
        widget_html: function() {
            ...
            '                            <button type="button">'+_this.settings.localization.avia_submit_button_text+'</button>'+
            '                        </li>'+
            '                    </ul>'+
            '                </form>'+
            ...
            '                </div>'+
            '                <form action="" method="get" autocomplete="off" ' + (_this.settings.open_in_new_tab ? 'target="_blank"' : '') + '>'+
            '                    <ul class="twidget-form-list clearfix">'+
            '                        <!-- hotel city input -->'+
    ...
    $('html').click(function(){
        $('.twidget-auto-fill-wrapper.active ul li:first-child').trigger('');
    });
